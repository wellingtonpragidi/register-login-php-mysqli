...
if(isset($_POST['access'])) : 
	...
	if( empty($email) or empty($pass) ) {
		...
		if( mysqli_num_rows($result) > 0 ) {
				...
				if($result_check > 0 && $hash_pass_check == 1) {
			...
			AlertError('E-mail inválido <br /> Usuário inesistente');
		}
...
?>
    ...
    <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
        <div class="form-group">
            ...
            <input name="f_email" type="text" class="form-control" id="email" placeholder="E-mail" value="<?php if(isset($_POST['access'])){echo $email;} ?>" required />
      </div>
        <div class="form-group">
